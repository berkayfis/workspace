        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageId = table.Column<Guid>(nullable: false, defaultValueSql : "NewId()") //, defaultValue: Guid.NewGuid()
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Ogrenci1No = table.Column<string>(nullable: true),
                    Ogrenci2No = table.Column<string>(nullable: true),
                    Danismanid = table.Column<int>(nullable: true),
                    Isim = table.Column<string>(nullable: true),
                    OturumNo = table.Column<int>(nullable: true),
                    Turu = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.Ogrenci1No,
                        principalTable: "Ogrenci",
                        principalColumn: "OgrenciNo",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__OGRENCI_P__OGRNO__34C8D9D1",
                        column: x => x.Ogrenci2No,
                        principalTable: "Ogrenci",
                        principalColumn: "OgrenciNo",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OgrenciProjeOnerisi_Ogrenci1No",
                table: "OgrenciProjeOnerisi",
                column: "Ogrenci1No");

            migrationBuilder.CreateIndex(
                name: "IX_OgrenciProjeOnerisi_Ogrenci2No",
                table: "OgrenciProjeOnerisi",
                column: "Ogrenci2No");
